...
_PLUGIN_COMPAT_LAZY = {
    ...
    'get_terminal_runtime': ('hermes_cli.web_routers.tools', 'get_terminal_runtime'),
    'assign_terminal_runtime': ('hermes_cli.web_routers.tools', 'assign_terminal_runtime'),
    'stop_terminal_runtime': ('hermes_cli.web_routers.tools', 'stop_terminal_runtime'),
